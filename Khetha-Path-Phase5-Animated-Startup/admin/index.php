...
<body><div class="app-shell"><header class="topbar"><a class="brand" href="../index.php"><img class="khetha-logo small-logo" src="../assets/images/khetha-logo.png" alt="Khetha"></a><span class="status-pill">Governance Demo</span></header>
